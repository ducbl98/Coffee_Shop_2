...
<div class="container">
    ...
    <table class="table">
        ...
        <?php foreach ($results as $key =>$result):?>
            <tr>
                <td><input type="checkbox" name="listId[<?php echo $key ?>]" value="<?php echo $result['id']?>"></td>
                <td><?php echo $result['name']?></td>
                <td><img src="<?php echo $result['image']?>"></td>
                <td><input type="number" name="price[<?php echo $key ?>]" value="<?php echo (int)$result['price']?>"></td>
